        ...
        ICanvasElement
    {
        ...
        public string text
        {
            get
            {
                ...
                if (m_Keyboard != null && m_Keyboard.active && !InPlaceEditing() &&
                    EventSystem.GetSystem(this.EventSystemID).currentSelectedGameObject == gameObject)
                {
        ...
        private bool MayDrag(PointerEventData eventData)
        {
            ...
            if (!this.CompareEventSystemID(eventData))
                // exit method execution with false
                return false;
            return IsActive() &&
                   IsInteractable() &&
        ...
        {
            if (EventSystem.GetSystem(this.EventSystemID).currentSelectedGameObject != gameObject)
