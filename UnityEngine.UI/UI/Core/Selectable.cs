        ...
        ISelectHandler, IDeselectHandler
    {
        ...
        public bool              interactable
        {
            ...
            set
            {
                ...
                {
					if (m_Interactable && EventSystem.GetSystem(this.EventSystemID).currentSelectedGameObject == gameObject)
						EventSystem.GetSystem(this.EventSystemID).SetSelectedGameObject(null);
                    OnSetProperty();
                }
            }
        }
        ...
        protected override void OnValidate()
        {
            ...
            {
				if (!interactable && EventSystem.GetSystem(this.EventSystemID) != null && EventSystem.GetSystem(this.EventSystemID).currentSelectedGameObject == gameObject)
					EventSystem.GetSystem(this.EventSystemID).SetSelectedGameObject(null);
        ...
        public virtual void OnPointerDown(PointerEventData eventData)
        {
            ...
            if (IsInteractable() && navigation.mode != Navigation.Mode.None)
                EventSystem.GetSystem(this.EventSystemID).SetSelectedGameObject(gameObject, eventData);
        ...
        {
            if (EventSystem.GetSystem(this.EventSystemID).alreadySelecting)
                return;

            EventSystem.GetSystem(this.EventSystemID).SetSelectedGameObject(gameObject);
        }
    }
}
